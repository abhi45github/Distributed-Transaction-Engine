...
@REM -- Regular WinNT shell
set WRAPPER_JAR="".m2\wrapper\dists\apache-maven-3.8.6-bin\wrapper\maven-wrapper.jar""
if not exist %WRAPPER_JAR% (
    echo Downloading Maven
    "%JAVA_HOME%\bin\java.exe" -jar "%M2_HOME%\bin\maven-wrapper.jar" download
)
...
if exist "%M2_HOME%\bin\m2.exit" call "%M2_HOME%\bin\m2.exit"
:skipRcPost
